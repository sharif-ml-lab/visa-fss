...
do
    ...
    PREFIX="test_${DATASET}_lbgroup${LABEL_SETS}_scale_${SUPERPIX_SCALE}_vfold${EVAL_FOLD}"
    ...
    RELOAD_PATH="pretrained/feature_extractor/sslalpnet_ct_fold${EVAL_FOLD}.pth" # path to the reloaded model

    python3 -u tests/val_vss1.py with \
