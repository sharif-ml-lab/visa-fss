...
def evaluate_prop_2models(_run, _config, _log, model_ref, model_prop, reg_model):
        ...
        for curr_lb in test_labels:
            ...
            for curr_scan_count, sample_batched in enumerate(testloader):
                ...
                for q_part, p in enumerate(pivots):
                    ...
                    query_pred, _, _, assign_mats = model_ref( sup_img_part , sup_fgm_part, sup_bgm_part, query_images, isval = True, val_wsize = _config["val_wsize"] )
                ...
                for q_part, p in enumerate(pivots): 
                    ...
                    for z_id in range(p + 1, z_max + 1):
                        ...
                        query_pred, _, _, assign_mats = model_prop( sup_img_part , sup_fgm_part, sup_bgm_part, query_images, isval = True, val_wsize = _config["val_wsize"] )
...
def evaluate_prop_contextual_2models(_run, _config, _log, model_ref, model_prop, reg_model):
