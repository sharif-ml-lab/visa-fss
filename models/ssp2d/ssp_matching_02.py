...
class SSP_MatchingNet_02(nn.Module):
    def __init__(self, backbone, refine=False):
        super(SSP_MatchingNet_02, self).__init__()
    ...
    def forward(self, img_s_list, mask_s_list, img_q, mask_q):
        ...
        # print(len(feature_s_list))
        # print('fs', feature_s_list[0].shape)
        ...
        ASFP_1 = ASFP_1.squeeze(5).squeeze(4)
        FP_1 = FP * 0.5 + ASFP_1 * 0.5
        BP_1 = BP * 0.5 + ASBP_1 * 0.5
        # BP_1 = SSBP_1 * 0.3 + ASBP_1 * 0.7

        # print('fp1, bp1', FP_1.shape, BP_1.shape)
